...
function SendPost() {
    //Отправляю GET запрос и получаю ответ, (сделал тестовый файл send.php который считывал json файл)
...
//Функция поиска по нескольким словам
...
//Функция добавления результатов на форму
